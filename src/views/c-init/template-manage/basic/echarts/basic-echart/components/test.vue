<template>
  <div class="test-echart-vue">
    <c-echart :eId="echartInfo.id" :eInfo="echartInfo" :eInfoFs="echartInfoFs" @refresh="handleRefresh" @fullscreenIn="handleFullscreenIn" @fullscreenOut="handleFullscreenOut"></c-echart>
  </div>
</template>
