  ...
  <div class="basic-vue">
      ...
      <div class="c-search-condition">
        <el-form :model="form" ref="formRef">
          <el-form-item label="性别">
            <el-select v-model="form.gender" disabled :is-disabled="true" placeholder="请选择" style="width:120px" @change="handleChangeCondition('gender')">
    ...
    <div class="c-result" v-loading-c="{ isLoading: isLoading, onCancel: () => isLoading = false }">
      ...
      <c-card-header title="" icon="">
        ...
        <template #right>
          <c-button type="primary" i="" @click="handleShowScroll">滚动展示</c-button>
    ...
    <Scroll v-if="scrollDialog.visible" @close="scrollDialog.visible = false"></Scroll>
  </div>
</template>
...
// ^
// # 8、滚动展示
const scrollDialog = ref({})
function handleShowScroll() {
  let newOperateDialog = {
    visible: true,
  }
  scrollDialog.value = newOperateDialog
}
// ^
