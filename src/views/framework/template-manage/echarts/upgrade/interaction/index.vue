    ...
    <div class="c-result">
      ...
      <div class="right">
        <el-table :data="echartInfo.tableData" border class="c-table c-table-update" :stripe="false">
          ...
          <el-table-column :label="item.nameT" :prop="item.fieldN" align="center" class-name="c-table-update-column" v-for="(item, index) in echartInfo?.tableHeader?.columnList?.slice(1)" :key="index">
            <template #="scope">
